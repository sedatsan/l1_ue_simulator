...
### Stack
- Language: C++20
- Framework: nlohmann_json
- Build: CMake
- Target: Linux (Ericsson 6G Simulator)
...
### Layout
- src/: Source files
- include/l1_ue_simulator/: Headers
- tests/: Unit tests

### Conventions
- Use MISRA-inspired high reliability coding.

## 11. Project Learnings
- Fast path should have zero dynamic allocation.
